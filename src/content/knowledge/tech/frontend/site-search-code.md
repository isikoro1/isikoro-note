---
title: "コードで見る検索機能"
summary: "石ころ技術マップの検索機能を、search.json.ts と index.astro のコードの流れから読む解説。"
category: "Tech"
type: "article"
status: "draft"
created: "2026-07-14"
updated: "2026-07-14"
tags: ["Astro", "Search", "JavaScript", "Code Reading"]
aliases: ["検索機能のコード解説", "search.json.ts", "本文検索の実装"]
keywords:
  - import.meta.glob
  - raw import
  - frontmatter
...
このページでは、石ころ技術マップの検索機能をコードの流れで見ます。
...
検索対象は `src/content/knowledge/**/*.md` に置いているMarkdownです。
...
ここで先に `escapeHtml` しているのは、検索結果にHTMLをそのまま混ぜないためです。
...
ただし、個人の技術マップや小さなドキュメントサイトなら、まずはこの方式で十分です。
